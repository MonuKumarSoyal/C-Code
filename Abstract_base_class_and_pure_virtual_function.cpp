...
class Chennel{
    ...
    //    virtual void display(){} // simple virtual class
          virtual void display() = 0;  // now display is the pure virtual class and to execute the program we need to write a function named display in the inherited classes, and the now the base function is an Abstract base function.
};
